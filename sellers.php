    ...
    <body>
        ...
        <!-- <div class="terms">
            ...
            <h2>How To Register ?</h2>
                <p>
                    Go to sign in and register using the form.
                </p>
        ...
        <div class="acontainer">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<p class='apartment-title'> " . $row["sellerFName"] ." " . $row["sellerLName"] . "</p>";
                    echo "<p class='apartment-description'> " . $row["sellerEmail"] . "</p>";
                    echo "<p class='apartment-description'> " . $row["sellerPhone"] . "</p>";
                    echo "<p class='apartment-description'>" . $row["sellerAddress"] . " " . $row["sellerPcode"] . "</p>";
                    echo "<div class='view-btn'>";
                    echo "<a href='./php/sellerD.php?id=" . $row["seller_id"] . "'><button style='background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;'>Manage</button></a>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    $count++;
